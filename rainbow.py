...
# Add arguments
parser.add_argument("-i", "--Input", help = "Input database file with plaintext passwords for hashing.")
parser.add_argument("-d", "--Dictionary", help = "File path to the dictionary file used for brute forcing.")
# Add arguments
parser.add_argument("-ha", "--Hash", help = "Tells rainbow.py to create a json file with hashed passwords.", action="store_true")
